...
- Osho VBT Vol 1 (book_id beacab8b) export completed successfully: 95 pages OCR'd, 97/97 translations, 118 glossary terms, 23 chapters, 36 TOC entries. ePub 127KB, PDF 1010KB. All 5 quality gates passed (OCR sanity, translation completeness, glossary integrity, document structure, artifact availability). Export script: `scripts/export_osho.py`.
